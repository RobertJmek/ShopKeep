    ...
    RoleManager<IdentityRole> roleManager) : Controller
{
    ...
    public async Task<IActionResult> Index(string? search, string? role)
    {
        try
        {
            ...
            {
                list = list.Where(u => u.Roles != null && u.Roles.Contains(role)).ToList();
                ViewBag.SelectedRole = role;
            }

            // Obține toate rolurile pentru dropdown
            ViewBag.AllRoles = _roleManager.Roles.Select(r => r.Name!).OrderBy(r => r).ToList();

            return View(list);
        }
        catch (Exception)
        {
            TempData["message"] = "A apărut o eroare la încărcarea utilizatorilor";
    ...
    public async Task<IActionResult> EditRoles(string id)
    {
        ...
        {
            TempData["message"] = "A apărut o eroare la încărcarea utilizatorului";
    ...
    public async Task<IActionResult> EditRoles(AdminEditUserRolesVM vm)
    {
        ...
        {
            TempData["message"] = "A apărut o eroare la actualizarea rolurilor";
            return RedirectToAction("Index");
        }
    }
    ...
    public async Task<IActionResult> ToggleLock(string id)
    {
        ...
        {
            TempData["message"] = "A apărut o eroare la blocare/deblocare";
            return RedirectToAction("Index");
        }
    }
    ...
    public async Task<IActionResult> Delete(string id)
    {
        ...
        {
            TempData["message"] = "A apărut o eroare la ștergerea utilizatorului";
            return RedirectToAction("Index");
        }
    }
}
